...
Page {
        ...
        kindProperties: FreeFormTitleBarKindProperties {
            Container {
                ...
                ImageButton {
                    ...
                    defaultImageSource: Application.themeSupport.theme.colorTheme.style == VisualStyle.Dark ? "asset:///bugReportIcons/icon_left.png" : "asset:///bugReportIcons/icon_left_black.png"
                    onClicked: {
                        navBug.pop();
                    }
                }  
                            ...
                            Container {
                                ...
                                Container {
                                    ...
                                    Container {
                                        ...
                                        ImageView {
                                            imageSource: Application.themeSupport.theme.colorTheme.style == VisualStyle.Dark ? "asset:///bugReportIcons/icon_quoted_white.png" : "asset:///bugReportIcons/icon_quoted.png"
                                            minHeight: ui.du(3)
                                            minWidth: ui.du(3)
    ...
    actions: [
        ...
        ActionItem {
            ...
            imageSource: "asset:///bugReportIcons/icon_pen.png"
